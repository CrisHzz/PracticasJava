public class Consultor extends Persona{
    ...
    public Consultor(int id, String Cc, String nombre, String apellido, String domicilio, String telefono,String nombre_consultor,int numero_consultor){
        super(id, Cc, nombre_consultor, apellido, domicilio, telefono);
